...
class Connection{
    ...
    public static  function connect($query){
        ...
        $connection=mysql_connect("$DBHost", "root","123") or die("no connection to database".mysql_error());
        $db=mysql_select_db("Agre",$connection) or die("connection failed with the database".mysql_error());
