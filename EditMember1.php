    ...
    <body>
        <div id="page" align="center">
            ...
            <div id="content">
                <div id="leftpanel">
                    ...
                    <div class="table_content">
                        <div class="table_text">
                            ...
                            <span class="news_text"><a href="EditMember1.php">Edit Member</a></span><br />
                ...
                <div id="contenttext">
                    <form action="Script/EditMember1.php" method="POST">
                        <table border="0" cellspacing="10">

                            <tbody>
                                <tr>
                                    <td>National Identicard No:</td>
                                    <td><input type="text" name="nid" value="" size="10" /></td>
                                </tr>
                                <tr>
                                    <td></td>
