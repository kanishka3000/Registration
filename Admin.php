...
<body>
	<div id="page" align="center">
		...
		<div id="content">
			<div id="leftpanel">
				...
				<div class="table_content">
					<div class="table_text">
                        <span class="news_date"><a href="AdminConfirmations.php">Confirmations</a></span> <br /><br/>
                        <span class="news_text"><a href="AdminAddQualification.php">Add New Qualification</a></span><br />
			...
			<div id="contenttext">
				<span class="title_blue">Welcome Admin!</span><br />
				<span class="subtitle_gray">Home page</span><br />
				<br />
				<p class="body_text" align="justify">   </p>
			</div>
			<br />
			<br />
			<div class="footer">
				<br />
				<a href="#">Home</a> | <a href="#">About Us</a> | <a href="#">Products</a> | <a href="#">Our Services</a> | <a href="#">Contact Us</a> | University of Colombo School of Computing2009
			</div>
		</div>
	</div>
</body>
